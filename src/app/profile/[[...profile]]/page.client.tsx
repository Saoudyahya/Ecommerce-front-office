...
export function ProfilePageClient() {
  ...
  const handleEnableTwoFactor = () => {
    ...
    setTimeout(() => {
      try {
        // Mock QR code data - this would normally be generated by the backend
        // Using a placeholder image URL for the QR code
        const mockQrCodeUrl = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=otpauth://totp/Example:user@example.com?secret=JBSWY3DPEHPK3PXP&issuer=Example";
        setQrCodeData(mockQrCodeUrl);
        
        // Extract mock secret from the URL
        ...
        // Update local storage to reflect 2FA is enabled
  ...
  const handleDisableTwoFactor = () => {
    ...
    setTimeout(() => {
      try {
        // Update local storage to reflect 2FA is disabled
        const userData = JSON.parse(localStorage.getItem('mockUser') || '{}');
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => {
                ...
                if (nameInput && emailInput) {
                  // Update mock user data in local storage
                  const userData = JSON.parse(localStorage.getItem('mockUser') || '{}');
